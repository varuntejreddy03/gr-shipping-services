export default function WhatsAppButton() {
  const msg = encodeURIComponent('Hello GR Shipping Services, I need ship supply/repair assistance at [Port]. Please assist.')
  return (
    <a
      href={`https://wa.me/919652222993?text=${msg}`}
      target="_blank"
      rel="noreferrer"
