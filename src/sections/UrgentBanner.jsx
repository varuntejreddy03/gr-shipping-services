  ...
  return (
    <section className="py-20 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container-max text-center relative">
        ...
        <h2 className="font-display text-5xl md:text-7xl text-slate-900 mb-4">URGENT SUPPLY NEEDED?</h2>
        <p className="font-body text-slate-600 text-xl mb-8">We respond in under <span className="text-danger font-semibold">30 minutes.</span></p>
        <a
          href="tel:+919652222993"
          className="inline-flex items-center gap-4 bg-danger text-slate-900 font-heading font-bold text-xl px-10 py-5 rounded-xl hover:bg-red-600 transition-all hover:shadow-2xl hover:shadow-danger/30 group"
        >
